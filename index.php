    ...
    <script>
        ...
        playerInstance.setup({
            ...
            sharing: {
                heading: "分享",
                //link: "Custom Link",
                code: "<iframe src='<?php print((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') ? 'https://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] : 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); ?>' width='640' height='480' frameborder='0' scrolling='auto'></iframe>",
